...
class Utils: NSObject {
    ...
    @objc static func configureNavigationBar(){
        ...
        UINavigationBar.appearance().barTintColor = K.color.main_color
        UINavigationBar.appearance().tintColor = .white
        UINavigationBar.appearance().isTranslucent = false
        UINavigationBar.appearance().backgroundColor = K.color.main_color
    ...
    @objc static func changeStatusBackgroundColor(color:UIColor = K.color.main_color){
